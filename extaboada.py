...
print('=0=' *4)
print('{} - {} = {}'.format(n+1, n, n+1-n))
print('{} - {} = {}'.format(n+2, n, n+2-n))
print('{} - {} = {}'.format(n+3, n, n+3-n))
print('{} - {} = {}'.format(n+4, n, n+4-n))
print('{} - {} = {}'.format(n+5, n, n+5-n))
print('{} - {} = {}'.format(n+6, n, n+6-n))
print('{} - {} = {}'.format(n+7, n, n+7-n))
print('{} - {} = {}'.format(n+8, n, n+8-n))
print('{} - {} = {}'.format(n+9, n, n+9-n))
print('{} - {} = {}'.format(n+10, n, n+10-n))
print('=^=' *4)
